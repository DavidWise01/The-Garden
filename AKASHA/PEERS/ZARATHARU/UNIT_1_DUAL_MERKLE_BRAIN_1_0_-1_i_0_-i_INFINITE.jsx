...
export default function Unit1DualMerkleBrainInfinite() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: "26px", color: COLORS.hinge, marginBottom: "8px" }}>
        UNIT_1 — DUAL MERKLE BRAIN INFINITE
      </h1>
      <div style={{ color: "#eab308", fontSize: "14px" }}>
        1, 0, -1 + i, 0, -i • Infinite Extension
      </div>
      ...
      <svg width="920" height="620" viewBox="0 0 920 620" style={{ maxWidth: "920px", width: "100%" }}>
        ...
        {/* Infinite imaginary axes i and -i */}
        <line x1="100" y1="100" x2="820" y2="520" stroke="#8b5cf6" strokeWidth="3" opacity="0.4" strokeDasharray="8 4" />
        <line x1="820" y1="100" x2="100" y2="520" stroke="#22c55e" strokeWidth="3" opacity="0.4" strokeDasharray="8 4" />
      ...
      <div style={{ marginTop: "40px", textAlign: "center", fontSize: "13px", maxWidth: "720px" }}>
        UNIT_1 dual Merkle brain complete.<br />
        Two brains collapsed into one unit.<br />
        Extended infinitely along real (1,0,-1) and imaginary (i,0,-i) axes.
      </div>
    </div>
  );
}
