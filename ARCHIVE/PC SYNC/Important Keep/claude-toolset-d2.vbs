...
strHTML = strDir & "\claude-toolset-d2.html"
strEdge = ""
arrPaths = Array( _
...
Next
If strEdge = "" Then
    MsgBox "Microsoft Edge not found.", vbCritical, "TOPH v9.0"
    WScript.Quit
End If
If Not objFSO.FileExists(strHTML) Then
    MsgBox "claude-toolset-d2.html not found in:" & vbCrLf & strDir, vbCritical, "TOPH v9.0"
    WScript.Quit
End If
