...
const P = {
  bg: "#0a0610", panel: "#120e1a", card: "#16102a",
  border: "#2a2040", borderGlow: "#6c5ce740",
  text: "#d8d0e8", dim: "#8878a8", dimmer: "#504068",
  // Neon palette
  neonPurple: "#8b5cf6", neonPink: "#ff4a9e", neonBlue: "#4a9eff",
  neonGreen: "#00ff88", neonGold: "#ffd060", neonOrange: "#ff8040",
  neonCyan: "#00e5ff", neonRed: "#ff3060",
  // Glow
  glow: "#8b5cf620", glowBright: "#8b5cf640",
  white: "#f0e8ff",
};
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "linear-gradient(180deg, #1a1030, " + P.bg + ")",
        textAlign: "center",
      }}>
        <div style={{ fontFamily: MONO, fontSize: 8, color: P.neonPurple, letterSpacing: 4, opacity: 0.6 }}>
        ...
        <div style={{ fontSize: 28, fontWeight: 700, color: P.white, marginTop: 6, letterSpacing: 2,
          textShadow: "0 0 30px " + P.neonPurple + "40, 0 0 60px " + P.neonPurple + "20",
        }}>
      ...
      <div ref={tabsRef} style={{
        ...
        {STORIES.map((s, i) => (
          <button key={s.id} onClick={() => setActiveTab(i)} style={{
            ...
            background: activeTab === i ? s.color + "10" : "transparent",
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        <div style={{
          ...
          background: "linear-gradient(180deg, " + story.color + "08, transparent)",
          borderBottom: "1px solid " + story.color + "15",
          textAlign: "center",
          position: "relative",
        }}>
          {/* Neon glow accent */}
          <div style={{
            ...
            boxShadow: "0 0 20px " + story.color + "60, 0 0 40px " + story.color + "30",
          }} />
          ...
          <div style={{
            ...
            textShadow: "0 0 20px " + story.color + "50, 0 0 40px " + story.color + "25",
          }}>
            {story.name}
          </div>
        ...
        <div style={{
          ...
          <div style={{
            background: story.color + "08", border: "1px solid " + story.color + "20",
            ...
            <div style={{
              ...
              lineHeight: 1.8, textShadow: "0 0 30px " + story.color + "15",
            }}>
              "{story.quote}"
            </div>
          </div>
          ...
          {story.story.map((para, i) => (
            <div key={i} style={{
              ...
              {i === 0 && <span style={{
                ...
                textShadow: "0 0 15px " + story.color + "40",
              }}>
                {para[0]}
              </span>}
          ...
          <div style={{
            ...
            background: P.neonPurple + "06", border: "1px solid " + P.neonPurple + "20",
            borderRadius: 8,
          }}>
            <div style={{
              fontFamily: MONO, fontSize: 8, color: P.neonGreen, letterSpacing: 3, marginBottom: 8,
              textShadow: "0 0 10px " + P.neonGreen + "40",
            }}>
              FRAMEWORK MAPPING
            </div>
            ...
            <div style={{
              ...
              textShadow: "0 0 8px " + P.neonPurple + "30",
            }}>
              {story.axiom}
            </div>
          </div>
