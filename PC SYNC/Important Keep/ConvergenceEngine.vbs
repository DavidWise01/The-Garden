...
htmlFile = appDir & "\CONVERGENCE-ENGINE.html"
...
For Each p In edgePaths
  If fso.FileExists(p) Then
    WshShell.Run Chr(34) & p & Chr(34) & " --app=""file:///" & Replace(htmlFile, "\", "/") & """ --window-size=1300,850 --disable-extensions --new-window", 0, False
    WScript.Quit
  End If
Next
